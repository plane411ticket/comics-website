...
//       try {
//         const detail = await fetchStoryDetails(String(audioId));
...
//       try {
//         const chapterList = await fetchStoryChapters(String(audioId));
...
//     try {
//       const updated = await updateNumberFavorite(String(audioId));
//       if (story) {
...
//               {firstChapter && (
//                 <Link
//                   to={`/audio/chapter/${firstChapter._id}`}
//                 >
...
//               {lastChapter && (
//                 <Link
//                   to={`/audio/chapter/${lastChapter._id}`}
//                 >
...
//                   <div className="p-1">
//                     <p>
//                       <Link to={`/audio/chapter/${chapter._id}`} className="text-neutral-700 hover:text-orange-500 dark:text-white">
