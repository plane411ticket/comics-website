                ...
                <div className="bg-gray-800 w-5/5 mr-10 border-t-orange-500 border-t-5">
                    ...
                    <form className="bg-gray-800 ml-10 mr-10 ">
                        ...
                        <div className="mb-4 w-full">
                            ...
                            <input type="email" className="p-2 border rounded w-full" placeholder="Nhập email hoặc user name" required />
                        </div>
                        <div className="mb-4 w-full">
                        ...
                        <div className="h-4"></div>
                        <button type="submit" className="w-full  bg-orange-500 text-white p-2 rounded hover:bg-yellow-400">Đăng ký</button>
                        <div className="h-4"></div>
