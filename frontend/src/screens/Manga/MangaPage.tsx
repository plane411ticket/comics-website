...
const MangaPage = () => {
    ...
    return (
        <div>
            <div className="w-240 overflow-hidden relative flex justify-center mx-auto">
                ...
                >
                    {slides.map((src, index) => (
                        <div 
                        key={index} 
                        className="relative min-w-full h-96 flex items-center justify-center rounded-2xl">
                            <img src={src} className="w-[900px] h-90"></img>
                            <div className="absolute bottom-13 left-85 -translate-x-1/2 flex flex-col pl-3" style={{backgroundColor:"hsla(0, 0%, 0%, 0.7)"}}>
                                <a href="#"><h4 className="text-white text-lg font-bold left-0">{names[index]}</h4></a>
                                <p className="text-white text-sm">{description[index]}</p>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <div className="mx-auto justify-center w-240">
                <h2 className="font-bold text-lg ">🌟 NỔI BẬT 🌟</h2>
                <div className="grid grid-cols-6 gap-3">
                    {
                        mangaData.map((manga, index) => (
                            <div key={index} className="p-4 text-black">
                                <img src={manga.image} alt={manga.title} className="w-full h-40 object-cover" />
                                <div className="p-2">
